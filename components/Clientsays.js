...
<div className='container mx-auto'>
  <h4 className='md:text-[40px] text-[25px] pb-2 md:pb-0 text-white font-bold text-center'>{ClientsaysContent == '' || ClientsaysContent == null || ClientsaysContent == undefined ? 'What our clients say' : ClientsaysContent.heading}</h4>
