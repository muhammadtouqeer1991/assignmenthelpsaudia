...
<div className='container mx-auto py-6'>
    <div>
    <h4 className='text-[34px] text-center text-white font-bold'>{WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? 'Order us and Avail the Amazing Benefits that you Deserve!' : WhychooseContent.heading }</h4>
