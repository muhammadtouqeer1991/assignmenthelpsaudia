...
<>
  ...
  <div className='container mx-auto'>
    <h2 className='text-[45px] font-bold text-center text-white'>{BackbonecontentData == null || BackbonecontentData == '' || BackbonecontentData == undefined ? 'Quality – Backbone of Assignment Help' : BackbonecontentData.heading}</h2>
