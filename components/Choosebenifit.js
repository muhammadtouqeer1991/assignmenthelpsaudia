...
<div className='absolute top-0 right-[-1px] rounded-full bg-navcolor w-14 h-14 flex justify-center items-center'>
    {
        pathname == '/' ? <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[0].icon} alt="market" width={30}  /> : <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[0].icon} alt="market" width={30} style={{mixBlendMode:'difference'}} />
    }
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    {
        pathname == '/' ? <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[1].icon} alt="market" width={30} /> : <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[1].icon} alt="market" width={30} style={{mixBlendMode:'difference'}} />
    }
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    {
        pathname == '/' ?  <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[2].icon} alt="market" width={30} /> :  <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[2].icon} alt="market" width={30} style={{mixBlendMode:'difference'}} />
    }
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    {
         pathname == '/' ? <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[3].icon} alt="market" width={30} /> : <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[3].icon} alt="market" width={30} style={{mixBlendMode:'difference'}} />
    }
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    {
        pathname == '/' ? <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[4].icon} alt="market" width={30} /> : <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[4].icon} alt="market" width={30} style={{mixBlendMode:'difference'}} />
    }
