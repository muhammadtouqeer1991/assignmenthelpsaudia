...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[1].icon} alt="market" width={30} />
</div>
</div>
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[2].icon} alt="market" width={30} />
</div>
</div>
<div className='bg-benifitcolor rounded-[65.5px] relative py-4 px-10 pl-7 font-semibold pr-[8rem] md:left-[4rem]'>
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[3].icon} alt="market" width={30} />
</div>
</div>
...
<div className='absolute top-0 right-[-1px] rounded-full bg-navactive w-14 h-14 flex justify-center items-center'>
    <Image src={WhychooseContent == null || WhychooseContent == '' || WhychooseContent == undefined ? '' : WhychooseContent.option[4].icon} alt="market" width={30} />
</div>
</div>
</div>
</>
